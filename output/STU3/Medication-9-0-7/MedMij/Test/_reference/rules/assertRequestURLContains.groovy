...
assert request.getURL().contains("${param.searchparam1}") || request.getURL().contains("${param.searchparam2}"): "The search URL did not contain one of the expected search parameters: ${param.searchparam1} or ${param.searchparam2}"