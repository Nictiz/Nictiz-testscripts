...
java -jar ${saxon} -xsl:"createTestScript.xsl" -s:createTestScript.xsl -o:../_LoadResources/medmij-gpdata-fhir3-0-2-load-resources-createupdate-xml.xml  inputDir1=$inputDir2 inputDir2=$outputDir1
echo "Creating Delete TestScript resource from fixtures"
java -jar ${saxon} -xsl:"createTestScript.xsl" -s:createTestScript.xsl -o:../_ClearResources/medmij-gpdata-fhir3-0-2-clear-resources-delete-xml.xml  inputDir1=$inputDir2 inputDir2=$outputDir1
cd "$pwd"