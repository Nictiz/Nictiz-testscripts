...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns:nf="http://www.nictiz.nl/functions" xmlns:f="http://hl7.org/fhir" xmlns:nts="http://nictiz.nl/xsl/testscript" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:util="urn:hl7:utilities" version="2.0" xmlns="" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:param name="nhgFixture" select="document('../../../../../HL7-mappings/ada_2_fhir-r4/lab/l2z-3.0.0/sturen_laboratoriumresultaten/fhir_instance/lr-slr-TEST-l2z-7Meesturen-met-ander-bericht-MO-4KCNHGLosresultaat.xml')"/>
    <xsl:param name="nhgId" select="'mv-mp-vo-tst-4-2-a-nierfunctie-NHG-v30'"/>
    
    <xsl:param name="loincFixture" select="document('../../../../../HL7-mappings/ada_2_fhir-r4/lab/l2z-3.0.0/sturen_laboratoriumresultaten/fhir_instance/lr-slr-TEST-l2z-7Meesturen-met-ander-bericht-MO-3AKCLOINCLosresultaat.xml')"/>
    <xsl:param name="loincId" select="'mv-mp-vo-tst-4-2-b-nierfunctie-loinc-zonder-panel-v30'"/>
    
    <xsl:param name="nhgFixtureCert" select="document('../../../../../HL7-mappings/ada_2_fhir-r4/lab/l2z-3.0.0/sturen_laboratoriumresultaten/fhir_instance/lr-slr-KWAL-l2z-3Meesturen-met-ander-bericht-MO-4KCNHG.xml')"/>
    <xsl:param name="nhgIdCert" select="'mv-mp-vo-kwal-script4a-v30'"/>
    
    <xsl:param name="loincFixtureCert" select="document('../../../../../HL7-mappings/ada_2_fhir-r4/lab/l2z-3.0.0/sturen_laboratoriumresultaten/fhir_instance/lr-slr-KWAL-l2z-3Meesturen-met-ander-bericht-MO-3KCLOINC.xml')"/>
